...
public class License {
    ...
    public boolean register(){
        log(0, " ");
        log(0, " ");
        log(0, Main.PREFIX + " Verbinde zum Lizenz-Server...");
        ValidationType vt = isValid();
        if(vt == ValidationType.VALID){
            log(1, Main.PREFIX + " Die Lizenz wurde aktzeptiert! Viel Spaß");
            log(0, " ");
            log(0, " ");
            return true;
        }else{
            log(0, " ");
            log(1, Main.PREFIX + " Lizenz wurde nicht aktzeptiert!");
            log(1, Main.PREFIX + "      Plugin deaktiviert!");
            log(0, " ");
            log(0, " ");
